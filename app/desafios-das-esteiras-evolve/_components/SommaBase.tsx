...
import { COPY, EVENT_PATH, UNITS, inscricoesAbertas } from "@/lib/desafio-esteiras/event.config";
      ...
      <div className="dst-wrap relative grid items-center gap-10 md:grid-cols-12 md:gap-14">
        <div className="md:col-span-7">
          ...
          <p className="sb-anim mt-7 max-w-[48ch] text-[clamp(1rem,2.6vw,1.22rem)] font-medium leading-relaxed">
            A equipe do SOMMA Club estará presencialmente na Evolve Vicente Pires. É lá que a
            comunidade se concentra: quem corre com o clube, quem quer conhecer, e quem só quer
            estar perto de gente que treina junto.
          </p>

          <ul className="sb-anim mt-8 grid gap-3 sm:grid-cols-3">
            {[
              { k: "Base", v: "Vicente Pires" },
              { k: "Equipe", v: "SOMMA Club" },
              { k: "Operação", v: "Evolve" },
            ].map((item) => (
        ...
        <div className="sb-foto-wrap relative order-first aspect-[4/5] overflow-hidden md:order-none md:col-span-5">
          ...
          />
          <span className="dst-label absolute bottom-4 left-4 bg-[color:var(--ink)] px-3 py-2 text-[color:var(--somma)]">
            SOMMA BASE · VICENTE PIRES
          </span>
        </div>
      </div>
    </section>
