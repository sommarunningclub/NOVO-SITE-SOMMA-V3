...
export const FOTOS = {
  ...
  // O novo espaço, na SRPS Estacionamento 10 (pasta Novos-Espaço-Estacao-2026, ago. 2026)
  galpao: "/estacao-somma/novo-espaco/galpao-1.jpg",
  galpaoSalao: "/estacao-somma/novo-espaco/galpao-2.jpg",
  galpaoPerspectiva: "/estacao-somma/novo-espaco/galpao-3.jpg",
  salao: "/estacao-somma/novo-espaco/salao.jpg",
  palco: "/estacao-somma/novo-espaco/palco.jpg",
  areaCoberta: "/estacao-somma/novo-espaco/coberta.jpg",
  pracaAlimentacao: "/estacao-somma/novo-espaco/praca-alimentacao.jpg",
  fachada: "/estacao-somma/novo-espaco/fachada-1.jpg",
  fachadaLateral: "/estacao-somma/novo-espaco/fachada-2.jpg",
  fachadaCortinas: "/estacao-somma/novo-espaco/fachada-3.jpg",
  portaria: "/estacao-somma/novo-espaco/portaria.jpg",
  portao: "/estacao-somma/novo-espaco/portao.jpg",
  lagoArvores: "/estacao-somma/novo-espaco/lago-1.jpg",
  lagoSombra: "/estacao-somma/novo-espaco/lago-2.jpg",
  lagoCalcada: "/estacao-somma/novo-espaco/lago-3.jpg",
  lagoMargem: "/estacao-somma/novo-espaco/lago-4.jpg",
  vistaDoLago: "/estacao-somma/novo-espaco/vista-do-lago.jpg",
  areaAberta: "/estacao-somma/novo-espaco/area-1.jpg",
  areaAberta2: "/estacao-somma/novo-espaco/area-2.jpg",
  areaAberta3: "/estacao-somma/novo-espaco/area-3.jpg",
  bambuzal: "/estacao-somma/novo-espaco/bambuzal.jpg",
  pista: "/estacao-somma/novo-espaco/pista-1.jpg",
  pistaAsfalto: "/estacao-somma/novo-espaco/pista-2.jpg",
...
/**
 * O que o novo espaço já tem construído, lido das fotografias de agosto de
 * 2026. Nenhuma medida, capacidade ou metragem: nada disso está levantado.
 */
export const ESPACO_ATIVOS = [
  {
    titulo: "Galpão coberto",
    texto: "Uma área coberta grande, de pé direito alto e piso pronto, aberta nas laterais para o Parque.",
  },
  {
    titulo: "Palco montado",
    texto: "Estrutura de palco e som já instalada, com o salão inteiro em frente.",
  },
  {
    titulo: "Praça de alimentação",
    texto: "Balcão, cobertura e área de assentos: o café não começa do zero.",
  },
  {
    titulo: "Portaria e acesso",
    texto: "Guarita, portão e via de entrada próprios, separados do fluxo do Parque.",
  },
  {
    titulo: "Pátio aberto",
    texto: "Uma esplanada de terra batida ao lado da estrutura, do tamanho de um campo, para academia outdoor e eventos.",
  },
  {
    titulo: "Beira do lago",
    texto: "Margem sombreada por árvores maduras, com calçada e vista aberta para a água.",
  },
] as const;
...
export const SOMMA_QUER = [
  {
    titulo: "Dar endereço ao point da comunidade",
    texto: "O clube já se encontra no Estacionamento 10 todo fim de semana. O novo espaço fica a 260 metros dali: o ponto de encontro deixa de ser um combinado no estacionamento e passa a ter porta, cobertura e café.",
    itens: [] as readonly string[],
  },
  {
    titulo: "Fazer do espaço a base do clube",
...
/* ── 21b · Alinhamento das três partes ────────────────────────────────── */

/**
 * SOMMA Club, Evolve e Bugu Delícias na mesma mesa. "O que traz" é o que já
 * está documentado neste deck. "O que precisa dizer" é a pergunta que a
 * conversa faz para cada parte: nenhuma resposta está fechada.
 */
export const PARTES = [
  {
    quem: "SOMMA Club",
    traz: "Comunidade, corrida, eventos e conteúdo. O fluxo que já acontece no Parque todo fim de semana.",
    dizer: "Quanto do dia a dia do espaço o clube assume, e o que espera em troca de levar a comunidade para lá.",
  },
  {
    quem: "Evolve",
    traz: "Academia, performance, recovery, base de alunos e o produto premium Evolve+.",
    dizer: "Até onde vai o investimento, o que exige de exclusividade e o que a rede considera retorno.",
  },
  {
    quem: "Bugu Delícias",
    traz: "A operação de A&B: café colonial, confeitaria caseira, equipe e a rotina de quem já opera todos os dias.",
    dizer: "Como quer operar o café no Parque, de que estrutura precisa e como entra nos custos do espaço.",
  },
] as const;

/**
 * A pauta em aberto. São os pontos que precisam de decisão conjunta antes de
 * qualquer acordo: nada aqui está definido, e é esse o ponto do slide.
 */
export const PAUTA = [
  {
    titulo: "Administração",
    texto: "Quem responde pelo espaço no dia a dia: contrato, agenda, uso das áreas e a palavra final na operação.",
  },
  {
    titulo: "Limpeza e manutenção",
    texto: "Quem contrata e quem paga a limpeza diária, os banheiros, a área externa e a manutenção da estrutura.",
  },
  {
    titulo: "Custos fixos",
    texto: "Energia, água, internet, segurança, seguro e licenças. O que é rateio fixo e o que é cobrado por uso.",
  },
  {
    titulo: "Investimento na adequação",
    texto: "Quem banca cada parte da obra e como esse investimento se converte em participação na operação.",
  },
  {
    titulo: "Receita e divisão",
    texto: "A&B, recovery, lockers, aulas, eventos e locação: o que cada frente gera e como se divide.",
  },
  {
    titulo: "Exclusividade",
    texto: "O que é exclusivo de cada parte e quais categorias de marca ficam fechadas para terceiros.",
  },
  {
    titulo: "Nome e assinatura",
    texto: "Como o espaço se chama e quais marcas aparecem onde. O nome ainda está em aberto.",
  },
  {
    titulo: "Governança",
    texto: "Com que frequência as três partes se sentam, quem decide o quê e como se resolve divergência.",
  },
  {
    titulo: "Prazo e saída",
    texto: "Duração do acordo, renovação e o que acontece com a estrutura se uma parte quiser sair.",
  },
] as const;
