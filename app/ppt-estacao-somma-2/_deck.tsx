...
import { MapaNovoEspaco, NOVO_ESPACO } from "./_mapa";
...
export function Deck({ opcionais, app }: { opcionais: Opcionais; app: { url: string; qr: string } }) {
  ...
  return (
    ...
    >
      ...
      <Slide index={idx("espaco")} name="espaco" tema="grafite">
        <Miolo>
          <div className="grid items-end gap-10 lg:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <H2>
                Não é um terreno.
                <br />
                É uma <Accent>estrutura pronta</Accent>
              </H2>
            </div>
            <Lead className="lg:mb-2 lg:max-w-xl lg:justify-self-end">
              Depois da conversa com a Evolve, o projeto passou a olhar para outro ponto do Parque: um complexo já
              construído na SRPS Estacionamento 10, com galpão coberto, palco, praça de alimentação, portaria
              própria e um pátio aberto na beira do lago. A 260 metros de onde o SOMMA já se encontra todo fim de
              semana.
            </Lead>
          </div>
          ...
          <div className="mt-9 grid gap-4 lg:grid-cols-[1.55fr_1fr]">
            <Foto
              src={FOTOS.fachadaLateral}
              alt="O complexo coberto entre as árvores, no Parque da Cidade"
              legenda="O complexo, entre as árvores"
              ratio="aspect-[16/9.2]"
              sizes="60vw"
            />
            <div className="grid grid-rows-2 gap-4">
              <Foto
                src={FOTOS.salao}
                alt="Salão coberto do galpão"
                legenda="Salão coberto"
                ratio="aspect-[16/7.4]"
                position="50% 55%"
                sizes="36vw"
              />
              <Foto
                src={FOTOS.lagoArvores}
                alt="Margem do lago com árvores maduras, ao lado da estrutura"
                legenda="A margem do lago, ao lado"
                ratio="aspect-[16/7.4]"
                position="50% 55%"
                sizes="36vw"
              />
          ...
          <Nota className="mt-6">
            Fotografias da situação atual, agosto de 2026. O espaço opera hoje como casa de eventos, registrado
            como {NOVO_ESPACO.referencia}. A situação jurídica e regulatória será validada como etapa do projeto.
          </Nota>
        </Miolo>
        <Rodape />
      </Slide>

      {/* ═══════════ 03c · O QUE JÁ ESTÁ DE PÉ ═══════════ */}
      <Slide index={idx("espaco-ativos")} name="espaco-ativos" tema="claro">
        <Miolo>
          <div className="grid items-end gap-10 lg:grid-cols-[1.15fr_1fr]">
            <div>
              <Kicker>O que já está de pé</Kicker>
              <H2>
                O ponto de partida
                <br />
                não é uma <Accent>obra do zero</Accent>
              </H2>
            </div>
            <Lead className="lg:mb-2 lg:max-w-xl lg:justify-self-end">
              O que existe hoje já cobre boa parte do programa da Estação. A conversa deixa de ser sobre construir
              e passa a ser sobre adequar, ocupar e operar.
            </Lead>
          </div>

          <div className="mt-9 grid items-start gap-10 lg:grid-cols-[1.3fr_1fr]">
            <Linhas itens={ESPACO_ATIVOS} colunas={2} tamanho="sm" cor={ORANGE} />
            <div className="grid grid-cols-2 gap-3">
              <Foto src={FOTOS.salao} alt="Salão coberto do galpão" ratio="aspect-[4/3]" legenda="Salão coberto" sizes="24vw" />
              <Foto src={FOTOS.pracaAlimentacao} alt="Praça de alimentação existente" ratio="aspect-[4/3]" legenda="Praça de alimentação" sizes="24vw" />
              <Foto src={FOTOS.areaAberta} alt="Pátio aberto ao lado da estrutura" ratio="aspect-[4/3]" legenda="Pátio aberto" sizes="24vw" />
              <Foto src={FOTOS.portaria} alt="Portaria e acesso próprio do espaço" ratio="aspect-[4/3]" legenda="Portaria própria" sizes="24vw" />
            </div>
          </div>
        </Miolo>
        <Rodape />
          ...
          <div className="grid items-end gap-8 lg:grid-cols-[1.2fr_1fr]">
            <div className="max-w-2xl">
              ...
              <H2>
                Onde o clube
                <br />
                <Accent>já se encontra</Accent>
              </H2>
              <Lead className="text-white/75">
                Estacionamento 10, entre a pista, o lago e o fluxo de quem corre e caminha todos os dias. O ponto de
                encontro do SOMMA não muda de lugar: ganha uma casa a 260 metros dele.
              </Lead>
            </div>
            <div className="border-l border-white/25 pl-6 lg:justify-self-end">
              ...
              <p className="a-up mt-1.5 text-[13.5px] text-white/65">{NOVO_ESPACO.endereco}</p>
              <p className="a-up mt-1 font-mono text-[11px] tracking-[0.15em] text-white/45">
                {NOVO_ESPACO.lat}, {NOVO_ESPACO.lng} · {NOVO_ESPACO.plusCode}
              </p>
            </div>
          </div>
        </Miolo>
      ...
      <Slide index={idx("conceito")} name="conceito">
        <Miolo>
          ...
          <Foto
            ...
            legenda="Estudo conceitual · referência de linguagem, desenhada antes da definição do novo espaço"
      ...
      <Slide index={idx("nova-casa")} name="nova-casa" tema="claro">
        <Miolo>
          ...
          <H2>
            ...
            <br />
            ganha um <Accent>endereço</Accent>
          </H2>
        ...
        <Miolo>
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.4fr]">
            <div>
              ...
              <Lead>
                A Estação não é um desejo abstrato. O clube precisa de duas coisas no Parque, e o novo espaço
                resolve as duas.
              </Lead>
            </div>
                    ...
                    {q.itens.length ? (
                      ...
                      <div className="mt-5 flex flex-wrap items-baseline gap-x-6 gap-y-2 font-display uppercase tracking-tight">
                        <span className="text-[color:var(--fg-faint)]">
                          ...
                          <span className="mt-1 block text-xl font-semibold sm:text-2xl">Combinado no estacionamento</span>
                        </span>
                        ...
                        <span>
                          ...
                          <span className="mt-1 block text-xl font-semibold sm:text-2xl">Casa a 260 metros</span>
                        </span>
                      </div>
                    )}
                  </div>
      ...
      <Slide index={idx("alinhamento")} name="alinhamento">
        <Miolo>
          <div className="grid items-end gap-10 lg:grid-cols-[1.2fr_1fr]">
            <div>
              <Kicker>Agora somos três</Kicker>
              <H2>
                O que precisa ser
                <br />
                <Accent>combinado antes</Accent>
              </H2>
            </div>
            <Lead className="lg:mb-2 lg:max-w-xl lg:justify-self-end">
              Os donos do Bugu já disseram sim à ideia. Antes de qualquer acordo, SOMMA, Evolve e Bugu precisam
              alinhar expectativas: quem administra, quem limpa, quem paga o quê e o que cada um espera de retorno.
            </Lead>
          </div>

          <div className="mt-10 grid gap-x-10 sm:grid-cols-3">
            {PARTES.map((parte, i) => (
              <div key={parte.quem} className="a-up border-t border-[color:var(--line)] pt-4">
                <div className="flex items-baseline gap-3">
                  <Indice n={String(i + 1).padStart(2, "0")} cor={ORANGE} />
                  <p className="font-display text-xl font-bold uppercase leading-none tracking-tight sm:text-2xl">
                    {parte.quem}
                  </p>
                </div>
                <p className="mt-3 text-[13.5px] font-light leading-relaxed text-[color:var(--fg-soft)]">
                  {parte.traz}
                </p>
                <p className="mt-4 font-display text-[10px] font-semibold uppercase tracking-[0.3em] text-[color:var(--fg-faint)]">
                  Precisa dizer
                </p>
                <p className="mt-2 text-[13.5px] font-light leading-relaxed text-[color:var(--fg-soft)]">
                  {parte.dizer}
                </p>
              </div>
            ))}
          ...
          <p className="a-up mt-11 font-display text-[10px] font-semibold uppercase tracking-[0.4em] text-[color:var(--fg-faint)]">
            A pauta em aberto
          </p>
          <div className="mt-3 grid gap-x-8 sm:grid-cols-2 lg:grid-cols-3">
            {PAUTA.map((item, i) => (
              <div key={item.titulo} className="a-up border-t border-[color:var(--line)] py-3.5">
                <div className="flex items-baseline gap-3">
                  <Indice n={String(i + 1).padStart(2, "0")} />
                  <div>
                    <p className="font-display text-base font-semibold uppercase leading-none tracking-tight sm:text-lg">
                      {item.titulo}
                    </p>
                    <p className="mt-1.5 text-[12.5px] font-light leading-snug text-[color:var(--fg-soft)]">
                      {item.texto}
                    </p>
                  </div>
                </div>
          ...
          <Nota className="mt-7">
            Nenhum item acima está decidido. A lista existe para a conversa entre as três partes ter começo, meio e
            fim, e para ninguém sair da mesa com uma expectativa que o outro não assumiu.
          </Nota>
        </Miolo>
        <Rodape />
      </Slide>
