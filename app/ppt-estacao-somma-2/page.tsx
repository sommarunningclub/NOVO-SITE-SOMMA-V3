...
const URL_PRODUCAO = "https://sommaclub.com.br/ppt-estacao-somma-2/app";
...
async function urlDoApp(forcarProducao: boolean): Promise<string> {
  if (forcarProducao || process.env.ESTACAO_SOMMA_2_APP_URL) {
    return process.env.ESTACAO_SOMMA_2_APP_URL || URL_PRODUCAO;
  }
  ...
  return `${proto}://${host}/ppt-estacao-somma-2/app`;
}
