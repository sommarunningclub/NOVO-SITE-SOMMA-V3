...
/**
 * Trava da nova proposta Michelob.
 *
 ...
 * (PPT_MICHELOB_NOVA_PROPOSTA_CODE ou PPT_MICHELOB_CODE). Sem a variável, o deck não abre:
 * o código padrão que ficava aqui no fonte foi removido.
 */
const auth = criarPptAuth("ppt-michelob-nova-proposta", ["PPT_MICHELOB_NOVA_PROPOSTA_CODE", "PPT_MICHELOB_CODE"]);
