...
/**
 * Tela de acesso da apresentação comercial.
 *
 * Igual à do /ppt-michelob, mas envia para o endpoint próprio desta rota, que
 * grava um cookie separado. Assim o pitch e a proposta financeira têm acessos
 * independentes.
 */
export function Gate() {
  ...
  const enviar = useCallback(
    async (valor: string) => {
      ...
      setErro(false);
      try {
        const r = await fetch("/api/ppt-michelob-proposta/auth", {
          method: "POST",
