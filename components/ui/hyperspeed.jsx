...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      init() {
        // Evita inicializar um app já descartado (StrictMode/desmontagem durante o loadAssets async).
    ...
    myApp.loadAssets().then(() => {
      // Só inicializa se o app ainda estiver vivo (não desmontado nesse meio tempo).
